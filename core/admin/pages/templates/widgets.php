                ...
                <div class="ste-my-2 ste-w-full md:ste-w-1/2 lg:ste-w-1/3 xl:ste-w-1/4">
                    <div class="ste-mx-2">
                        <label for="module-label-<?php echo $key ?>"
                               class="ste-flex ste-justify-between ste-items-center ste-border ste-border-solid ste-border-gray-300 ste-rounded ste-bg-gray-100 ste-p-4 hover:ste-border-gray-400">
        ...
        <div class="ste-mt-5">
            <button type="submit"
                ...
                <span class="ste-flex ste-items-center">
	                ...
	                <span class="ste-leading-normal ste-ml-2"><?php _e( 'Save', STAX_EL_DOMAIN ); ?></span>
                </span>
            </button>
        </div>
    </form>
