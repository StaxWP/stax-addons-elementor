...
class Component extends Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_dropdown',
			[
				'label' => __( 'Dropdown', 'stax-elementor' ),
			]
		);
		...
		$this->add_control(
			'dropdown_columns',
			[
				'label'       => __( 'Columns', 'stax-elementor' ),
				'description' => __( 'Max 3 columns can be displayed in the dropdown.', 'stax-elementor' ),
		...
		$this->add_control(
			...
			[
				'label'     => __( 'Column Spacing', 'stax-elementor' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => [
					'px' => [
						'max' => 50,
		...
		$repeater->add_control(
			'dropdown_item_text',
			[
				'label'       => __( 'Item Text', 'stax-elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
				'default'     => __( 'Item', 'stax-elementor' ),
				'placeholder' => __( 'Item', 'stax-elementor' ),
			]
		);
		...
		$repeater->add_control(
			'dropdown_item_link',
			[
				'label'       => __( 'Item Link', 'stax-elementor' ),
		...
		$repeater->add_control(
			...
			[
				'label'       => __( 'Item Column', 'stax-elementor' ),
				'description' => __( 'Attach this item to a column number.', 'stax-elementor' ),
				'type'        => Controls_Manager::NUMBER,
				'min'         => 1,
				'max'         => 3,
				'step'        => 1,
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'dropdown_item_text'   => __( 'My first item', 'stax-elementor' ),
						'dropdown_item_link'   => '#',
		...
		$this->add_control(
			'dropdown_link_color',
			[
				'label'     => __( 'Link Color', 'stax-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
