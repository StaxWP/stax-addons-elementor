...
class Component extends Base {
	...
	public function get_title() {
		return __( 'Scroll Top', 'stax-elementor-kit' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'scroll_speed',
			[
				'label'   => __( 'Scroll Speed (ms)', 'stax-elementor-kit' ),
		...
		$this->add_control(
			'show_offset',
			[
				'label'       => __( 'Show Top Offset', 'stax-elementor-kit' ),
				'description' => __( 'Show button when top offset is grated than the set value.', 'stax-elementor-kit' ),
