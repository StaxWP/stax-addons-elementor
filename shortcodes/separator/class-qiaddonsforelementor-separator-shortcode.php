...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Separator_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_separator_layouts', [] ) );
			$this->set_extra_options( apply_filters( 'qi_addons_for_elementor_filter_separator_extra_options', [] ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Divider', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that displays divider with provided parameters', 'stax-addons-for-elementor' ) );
			...
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/divider/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#1_divider' );
			...
			$this->set_option(
				[
					'field_type' => 'select',
					'name'       => 'position',
					'title'      => esc_html__( 'Position', 'stax-addons-for-elementor' ),
					'options'    => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Border Style', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Width (px or %)', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'vw' ],
					'range'      => [
						'px' => [
							'min' => 0,
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Thickness (px)', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Margin Top', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'vh' ],
					'range'      => [
						'px' => [
							'min' => 0,
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Margin Bottom', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'vh' ],
					'range'      => [
						'px' => [
							'min' => 0,
