...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Interactive_Banner_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_interactive_banner_layouts', [] ) );
			$this->set_extra_options( apply_filters( 'qi_addons_for_elementor_filter_interactive_banner_extra_options', [], $this ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Interactive Banners', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that adds interactive banners element', 'stax-addons-for-elementor' ) );
			...
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/interactive-banners/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#5_interactive_banners' );
			$this->set_option(
				[
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$show_text_layouts = array_keys( array_diff_key( $this->get_layouts(), apply_filters( 'qi_addons_for_elementor_filter_interactive_banner_layout_hide_text', [] ) ) );
			...
			$this->set_option(
				[
					...
					'name'       => 'banner_padding',
					'title'      => esc_html__( 'Banner Padding', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'vw' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'group'         => esc_html__( 'Content', 'stax-addons-for-elementor' ),
				]
			);
			$this->set_option(
				[
