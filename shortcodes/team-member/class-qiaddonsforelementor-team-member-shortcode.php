...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Team_Member_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_team_member_layouts', [] ) );
			$this->set_extra_options( apply_filters( 'qi_addons_for_elementor_filter_team_member_extra_options', [] ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Team', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that displays team member', 'stax-addons-for-elementor' ) );
			...
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/team/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#5_team' );
			...
			$this->set_option(
				[
					'field_type'    => 'text',
					'name'          => 'name',
					'title'         => esc_html__( 'Name', 'stax-addons-for-elementor' ),
					'default_value' => esc_html__( 'John Doe', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type'    => 'text',
					'name'          => 'role',
					'title'         => esc_html__( 'Role', 'stax-addons-for-elementor' ),
					'default_value' => esc_html__( 'Team Manager', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type'    => 'repeater',
					'name'          => 'children',
					'title'         => esc_html__( 'Social', 'stax-addons-for-elementor' ),
					'default_value' => [
						[
							'icon' => [
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'name_tag',
					'title'         => esc_html__( 'Name Tag', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'name_color',
					'title'      => esc_html__( 'Name Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Name Typography', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'role_color',
					'title'      => esc_html__( 'Role Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Role Typography', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'icons_color',
					'title'      => esc_html__( 'Icons Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Icons Hover Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'select',
					'name'       => 'image_hover',
					'title'      => esc_html__( 'Image Hover', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
					'options'    => [
						''      => esc_html__( 'None', 'stax-addons-for-elementor' ),
						'zoom'  => esc_html__( 'Zoom', 'stax-addons-for-elementor' ),
						'scale' => esc_html__( 'Scale', 'stax-addons-for-elementor' ),
					],
				]
			);
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Role Margin Bottom', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Name Margin Bottom', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Space Between Icons', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
