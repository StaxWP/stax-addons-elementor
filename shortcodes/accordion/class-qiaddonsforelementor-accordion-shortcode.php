...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Accordion_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_accordion_layouts', [] ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Accordions and Toggles', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that adds accordion/toggle holder', 'stax-addons-for-elementor' ) );
			...
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/accordions-and-toggles/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#accordions_and_toggles' );
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'behavior',
					'title'         => esc_html__( 'Behavior', 'stax-addons-for-elementor' ),
					'options'       => [
						'accordion' => esc_html__( 'Accordion', 'stax-addons-for-elementor' ),
						'toggle'    => esc_html__( 'Toggle', 'stax-addons-for-elementor' ),
					],
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'style',
					'title'         => esc_html__( 'Style', 'stax-addons-for-elementor' ),
					'options'       => [
						'standard'       => esc_html__( 'Standard', 'stax-addons-for-elementor' ),
						'boxed'          => esc_html__( 'Boxed', 'stax-addons-for-elementor' ),
						'border-top'     => esc_html__( 'Border Top', 'stax-addons-for-elementor' ),
						'border-between' => esc_html__( 'Border Between', 'stax-addons-for-elementor' ),
					],
			...
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Content Height', 'stax-addons-for-elementor' ),
					'options'       => [
						'auto'    => esc_html__( 'Tallest Item Height', 'stax-addons-for-elementor' ),
						'content' => esc_html__( 'Individual Item Height', 'stax-addons-for-elementor' ),
					],
					'dependency'    => [
						'show' => [
							'behavior' => [
			...
			$this->set_option(
				[
					'field_type'    => 'icons',
					'name'          => 'icon_open',
					'title'         => esc_html__( 'Open Icon', 'stax-addons-for-elementor' ),
					'default_value' => [
						'value'   => 'fas fa-plus',
						'library' => 'solid',
					],
			...
			$this->set_option(
				[
					'field_type'    => 'icons',
					'name'          => 'icon_close',
					'title'         => esc_html__( 'Close Icon', 'stax-addons-for-elementor' ),
					'default_value' => [
						'value'   => 'fas fa-minus',
						'library' => 'solid',
					],
			...
			$this->set_option(
				[
					...
					'dependency' => [
						'show' => [
							'style' => [
								'values'        => [ 'standard', 'border-top', 'boxed' ],
								'default_value' => 'standard',
							],
						],
					],
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Active', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Background Active Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active Padding', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Active End', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			$this->set_option(
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'content_color',
					'title'      => esc_html__( 'Content Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Content Active Background Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'slider',
					'name'       => 'items_space',
					'title'      => esc_html__( 'Items Space', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Icon Start', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
				...
				[
					...
					'items'         => [
						...
						[
							'field_type'    => 'html',
							'name'          => 'item_content',
							'title'         => esc_html__( 'Content', 'stax-addons-for-elementor' ),
