...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Timeline extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_timeline_layouts', [] ) );
			$this->set_extra_options( apply_filters( 'qi_addons_for_elementor_filter_timeline_extra_options', [] ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Timeline Showcase', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that adds timeline showcase element', 'stax-addons-for-elementor' ) );
			$this->set_category( esc_html__( 'Qi Addons For Elementor', 'stax-addons-for-elementor' ) );
			$this->set_subcategory( esc_html__( 'Showcase', 'stax-addons-for-elementor' ) );
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/timeline-showcase/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#9_timeline_showcase' );
			...
			$layouts_type     = apply_filters( 'qi_addons_for_elementor_filter_timeline_layouts_type', [] );
			...
			$this->set_option(
				[
					...
					'default_value' => [
						[
							'image' => $placeholder,
							'title' => esc_html__( 'Example Title 1', 'stax-addons-for-elementor' ),
							'date'  => '1980',
							'text'  => qi_addons_for_elementor_get_example_text( 'excerpt_short' ),
						],
						[
							'image' => $placeholder,
							'title' => esc_html__( 'Example Title 2', 'stax-addons-for-elementor' ),
							'date'  => '1983',
							'text'  => qi_addons_for_elementor_get_example_text( 'excerpt_short' ),
						],
						[
							'image' => $placeholder,
							'title' => esc_html__( 'Example Title 3', 'stax-addons-for-elementor' ),
							'date'  => '1989',
							'text'  => qi_addons_for_elementor_get_example_text( 'excerpt_short' ),
						],
					],
					'items'         => [
						[
							'field_type' => 'icons',
							'name'       => 'icon',
							'title'      => esc_html__( 'Point Icon', 'stax-addons-for-elementor' ),
						],
						[
							'field_type'    => 'image',
							'name'          => 'image',
							'title'         => esc_html__( 'Image', 'stax-addons-for-elementor' ),
						...
						[
							'field_type'    => 'text',
							'name'          => 'date',
							'title'         => esc_html__( 'Date', 'stax-addons-for-elementor' ),
							'dynamic'       => false,
							'default_value' => '2005',
						],
						[
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Enable Appear Animation', 'stax-addons-for-elementor' ),
					'options'    => qi_addons_for_elementor_get_select_type_options_pool( 'yes_no', false ),
					'group'      => esc_html__( 'Appear Animation', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					...
					'description' => esc_html__( 'Top/bottom and left/right padding will change sides for vertical separated type on every other item', 'stax-addons-for-elementor' ),
					'size_units'  => [ 'px', '%', 'em' ],
					'responsive'  => true,
					'selectors'   => [
						'{{WRAPPER}} .qodef-timeline--horizontal .qodef-e-title'                               => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-side .qodef-e-title'                     => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-separated .qodef-obverse .qodef-e-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-separated .qodef-reverse .qodef-e-title' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
					],
					'group'       => esc_html__( 'Spacing Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'date_color',
					'title'      => esc_html__( 'Date Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Date Typography', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Date Margin Bottom', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'description' => esc_html__( 'Left/right padding will change sides for vertical separated type on every other item', 'stax-addons-for-elementor' ),
					'size_units'  => [ 'px', '%', 'em' ],
					'responsive'  => true,
					'selectors'   => [
						'{{WRAPPER}} .qodef-timeline--horizontal .qodef-e-text'                               => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-side .qodef-e-text'                     => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-separated .qodef-obverse .qodef-e-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
						'{{WRAPPER}} .qodef-timeline-layout--vertical-separated .qodef-reverse .qodef-e-text' => 'padding: {{TOP}}{{UNIT}} {{LEFT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{RIGHT}}{{UNIT}};',
					],
					'group'       => esc_html__( 'Spacing Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Space Between Items', 'stax-addons-for-elementor' ),
					'size_units'    => [ 'px', 'em' ],
					'range'         => [
						'px' => [
							'min' => 0,
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns',
					'title'         => esc_html__( 'Number of Columns', 'stax-addons-for-elementor' ),
					...
					'group'         => esc_html__( 'Columns', 'stax-addons-for-elementor' ),
				]
			);
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Columns Responsive', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_1440',
					'title'         => esc_html__( 'Number of Columns 1367px - 1440px', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_1366',
					'title'         => esc_html__( 'Number of Columns 1025px - 1366px', 'stax-addons-for-elementor' ),
					'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'columns_number' ),
					'default_value' => '3',
					'dependency'    => [
						'relation' => 'and',
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_1024',
					'title'         => esc_html__( 'Number of Columns 769px - 1024px', 'stax-addons-for-elementor' ),
					'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'columns_number' ),
					'default_value' => '3',
					'dependency'    => [
						'relation' => 'and',
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_768',
					'title'         => esc_html__( 'Number of Columns 681px - 768px', 'stax-addons-for-elementor' ),
					'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'columns_number' ),
					'default_value' => '3',
					'dependency'    => [
						'relation' => 'and',
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_680',
					'title'         => esc_html__( 'Number of Columns 481px - 680px', 'stax-addons-for-elementor' ),
					'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'columns_number' ),
					'default_value' => '3',
					'dependency'    => [
						'relation' => 'and',
			...
			$this->set_option(
				[
					'field_type'    => 'select',
					'name'          => 'columns_480',
					'title'         => esc_html__( 'Number of Columns 0 - 480px', 'stax-addons-for-elementor' ),
					'options'       => qi_addons_for_elementor_get_select_type_options_pool( 'columns_number' ),
					'default_value' => '3',
					'dependency'    => [
						'relation' => 'and',
			...
			$this->set_option(
				[
					'field_type' => 'select',
					'name'       => 'line_type',
					'title'      => esc_html__( 'Line Type', 'stax-addons-for-elementor' ),
					'options'    => [
					...
					'group'      => esc_html__( 'Line & Point Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'line_color',
					'title'      => esc_html__( 'Line Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'slider',
					'name'       => 'line_thickness',
					'title'      => esc_html__( 'Line Thickness', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'select',
					'name'       => 'point_type',
					'title'      => esc_html__( 'Point Type', 'stax-addons-for-elementor' ),
					'options'    => [
						'standard' => esc_html__( 'Standard', 'stax-addons-for-elementor' ),
						'diamond'  => esc_html__( 'Diamond', 'stax-addons-for-elementor' ),
					],
					'group'      => esc_html__( 'Line & Point Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type' => 'slider',
					'name'       => 'point_position',
					'title'      => esc_html__( 'Point Position', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Diamond Lines Size', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'slider',
					'name'       => 'point_size',
					'title'      => esc_html__( 'Point Size', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'color',
					'name'       => 'point_color',
					'title'      => esc_html__( 'Point Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Point Border Radius', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Navigation Arrow Previous', 'stax-addons-for-elementor' ),
					'default_value' => [],
					'dependency'    => [
						'show' => [
							'layout' => [
					...
					'group'         => esc_html__( 'Navigation Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Navigation Arrow Next', 'stax-addons-for-elementor' ),
					'default_value' => [],
					'dependency'    => [
						'show' => [
							'layout' => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Navigation Arrow Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Navigation Arrow Size', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Navigation Arrow Offset', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'range'      => [
						'px' => [
							'min' => 0,
		...
		public function render( $options, $content = null ) {
			...
			$atts['type'] = apply_filters( 'qi_addons_for_elementor_filter_timeline_layouts_type', [] )[ $atts['layout'] ];
