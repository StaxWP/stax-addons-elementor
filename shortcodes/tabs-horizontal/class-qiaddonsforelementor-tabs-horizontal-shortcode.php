...
if ( class_exists( 'QiAddonsForElementor_Shortcode' ) ) {
	class QiAddonsForElementor_Tabs_Horizontal_Shortcode extends QiAddonsForElementor_Shortcode {
		...
		public function __construct() {
			$this->set_layouts( apply_filters( 'qi_addons_for_elementor_filter_tabs_horizontal_layouts', [] ) );
		...
		public function map_shortcode() {
			...
			$this->set_name( esc_html__( 'Horizontal Tabs', 'stax-addons-for-elementor' ) );
			$this->set_description( esc_html__( 'Shortcode that adds tabs holder', 'stax-addons-for-elementor' ) );
			...
			$this->set_demo( 'https://qodeinteractive.com/stax-addons-for-elementor/horizontal-tabs/' );
			$this->set_documentation( 'https://qodeinteractive.com/stax-addons-for-elementor/documentation/#3_horizontal_tabs' );
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Individual Title Alignment', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					'field_type' => 'border',
					'name'       => 'title_border',
					'title'      => esc_html__( 'Title Border', 'stax-addons-for-elementor' ),
					'selector'   => '{{WRAPPER}} .qodef-qi-tabs-horizontal .qodef-tabs-horizontal-navigation li a',
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Active/Hover', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active/Hover Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active/Hover Background', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active/Hover Underline Height', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active/Hover Underline Offset', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'range'      => [
						'px' => [
							'min' => - 10,
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Title Active/Hover Underline Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					...
					'title'         => esc_html__( 'Title Active/Hover Underline Draw', 'stax-addons-for-elementor' ),
					'options'       => [
						'left'   => esc_html__( 'From Left', 'stax-addons-for-elementor' ),
						'right'  => esc_html__( 'From Right', 'stax-addons-for-elementor' ),
						'center' => esc_html__( 'From Center', 'stax-addons-for-elementor' ),
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Active/Hover End', 'stax-addons-for-elementor' ),
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			$this->set_option(
			...
			$this->set_option(
				[
					...
					'title'      => esc_html__( 'Text Background Color', 'stax-addons-for-elementor' ),
					'selectors'  => [
			...
			$this->set_option(
				[
					'field_type' => 'border',
					'name'       => 'text_border',
					'title'      => esc_html__( 'Text Border', 'stax-addons-for-elementor' ),
					'selector'   => '{{WRAPPER}} .qodef-qi-tabs-horizontal .qodef-tabs-horizontal-content',
					'group'      => esc_html__( 'Style', 'stax-addons-for-elementor' ),
				]
			);
			...
			$this->set_option(
				[
					'field_type' => 'slider',
					'name'       => 'title_width',
					'title'      => esc_html__( 'Title Width', 'stax-addons-for-elementor' ),
					'size_units' => [ 'px', '%', 'em' ],
					'responsive' => true,
					'range'      => [
						'px' => [
